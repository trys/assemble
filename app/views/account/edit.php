...
<form method="POST">
	...
	<?php text_input( 'name', 'Your Name', check_object( $viewmodel->user, 'name' ), false );?>
	<?php text_input( 'email', 'Email Address', check_object( $viewmodel->user, 'email' ), false, array( 'type' => 'email' ) );?>
